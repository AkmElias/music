  ...
  <main>
    ...
    <section class="container mx-auto mt-6" id="comments">
      <div class="bg-white rounded border border-gray-200 relative flex flex-col">
        ...
        <div class="p-6">
          <div v-if="comment_show_alert" class="text-white text-center p-4 mb-4" :class="commment_alert_variant">
...
export default {
  ...
  data() {
    return {
      ...
      commment_alert_variant: "bg-blue-500",
  ...
  methods: {
    ...
    async addComment(values, { resetForm }) {
      ...
      this.commment_alert_variant = "bg-blue-500";
      ...
      this.commment_alert_variant = "bg-green-500";
